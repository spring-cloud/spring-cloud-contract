...
class MessagingKotlinFields implements Field, KotlinLanguageAcceptor {
	...
	MessagingKotlinFields(BlockBuilder blockBuilder,
	...
	@Override
	public Field call() {
		Arrays.stream(FIELDS).forEach(this.blockBuilder::addLine);
		return this;
	}
