...
World.'''"""
	...
	def 'should allow easier way of providing dynamic values for [#methodBuilderName]'() {
		...
		then:
			...
			test.contains('assertThatJson(parsedJson).field("[\'date\']").matches("(\\\\d\\\\d\\\\d\\\\d)-(0[4,6,9]|11)-(0[1-9]|[12][0-9]|3[0])|(\\\\d\\\\d\\\\d\\\\d)-(0[1,3,5,7,8]|10|12)-(0[1-9]|[12][0-9]|3[01])|(\\\\d\\\\d\\\\d\\\\d)-(02)-(0[1-9]|[12][0-8])"')
			test.contains('assertThatJson(parsedJson).field("[\'dateTime\']").matches("((\\\\d\\\\d\\\\d\\\\d)-(0[4,6,9]|11)-(0[1-9]|[12][0-9]|3[0])|(\\\\d\\\\d\\\\d\\\\d)-(0[1,3,5,7,8]|10|12)-(0[1-9]|[12][0-9]|3[01])|(\\\\d\\\\d\\\\d\\\\d)-(02)-(0[1-9]|[12][0-8]))T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])"')
