...
[source,java,indent=0]
----
include::src/test/groovy/org/springframework/cloud/contract/stubrunner/server/StubRunnerBootEurekaExample.java[tags=stubrunnereureka]
----
...
----
include::src/test/groovy/org/springframework/cloud/contract/stubrunner/server/StubRunnerBootEurekaExample.java[tags=stubrunnereureka_args]
----
