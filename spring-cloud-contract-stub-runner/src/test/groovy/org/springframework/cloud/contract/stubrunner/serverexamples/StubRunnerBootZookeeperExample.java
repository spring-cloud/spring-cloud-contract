 ...
 * -Dstubrunner.cloud.zookeepr.enabled=true -Dstubrunner.camel.enabled=false
 * -Dstubrunner.repositoryRoot=classpath:m2repo/repository/ -Deureka.client.enabled=false
 * -Ddebug=true
 *
 */
