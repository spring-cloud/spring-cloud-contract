 ...
 * -Dstubrunner.repositoryRoot=https://repo.spring.vmware.com/artifactory/spring-
 * commercial-snapshot-local (1) -Dstubrunner.cloud.stubbed.discovery.enabled=false (2)
