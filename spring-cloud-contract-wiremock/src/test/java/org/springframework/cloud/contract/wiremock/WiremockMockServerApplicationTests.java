...
public class WiremockMockServerApplicationTests {
	...
	public void simpleGetWithJsonBody() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate)
			.baseUrl("https://example.org")
			.stubs("classpath:/mappings/resource-with-json-body.json")
			.build();
	...
	public void simpleGetWithBase64Body() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate)
			.baseUrl("https://example.org")
			.stubs("classpath:/mappings/resource-with-base64-body.json")
			.build();
	...
	public void simpleGetWithEmptyPath() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/resource-with-empty-path.json")
			.build();
	...
	public void simpleGetWithContentType() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/resource-with-content-type.json")
			.build();
		assertThat(this.restTemplate.getForObject("https://example.org/resource", String.class))
			.isEqualTo("Hello World");
		server.verify();
	...
	public void simpleGetWithoutContentType() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/resource-without-content-type.json")
			.build();
		assertThat(this.restTemplate.getForObject("https://example.org/resource", String.class))
			.isEqualTo("Hello World");
		server.verify();
	...
	public void postWithHeader() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			...
			.stubs("classpath:/mappings/poster.json", "classpath:/mappings/accept.json")
			.build();
		assertThat(this.restTemplate
			.exchange(RequestEntity.post(new URI("https://example.org/poster")).accept(MediaType.TEXT_PLAIN).build(),
					String.class)
	...
	public void postWithHeaderContains() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") // order determined by content...
			.stubs("classpath:/mappings/poster.json", "classpath:/mappings/header-contains.json")
			.build();
		assertThat(this.restTemplate
			.exchange(RequestEntity.post(new URI("https://example.org/poster"))
				.accept(MediaType.valueOf("application/v.foo"))
				.build(), String.class)
	...
	public void postWithHeaderMatches() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") // order determined by content...
			.stubs("classpath:/mappings/poster.json", "classpath:/mappings/header-matches.json")
			.build();
		assertThat(this.restTemplate
			.exchange(RequestEntity.post(new URI("https://example.org/poster"))
	...
	public void simpleGetWithAllStubsInDirectoryWithPeriod() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/io.stubs/mappings")
			.build();
		assertThat(this.restTemplate.getForObject("https://example.org/resource", String.class))
			.isEqualTo("Hello World");
	}
	...
	public void postWithBodyMatchingJsonPaths() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/body-matches-jsonpath.json")
			.build();
	...
	public void postWithBodyMatchingXPath() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/body-matches-xpath.json")
			.build();

		assertThat(this.restTemplate
			.exchange(RequestEntity.post(URI.create("https://example.org/body"))
				.contentType(MediaType.APPLICATION_XML)
				.body("<things><thing><name>RequiredThing</name></thing></things>"), String.class)
			.getBody()).isEqualTo("Hello Body");
	}
	...
	public void postWithBodyMatchingJson() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/body-matches-equaltojson.json")
			.build();
	...
	public void postWithBodyMatchingXml() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/body-matches-equaltoxml.json")
			.build();
	...
	public void postWithBodyMatchingRegex() throws Exception {
		WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/body-matches-regex.json")
			.build();
	...
	public void getWithUrlPathMatching() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/url-path-pattern.json")
			.build();
	...
	public void getWithSimpleUrlPathMatchingWithTrailingSlashInBaseUrl() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate)
			.baseUrl("https://example.org/")
			.stubs("classpath:/mappings/url-simple-path-pattern-without-leading-slash.json")
			.build();
	...
	public void getWithSimpleUrlPathMatchingWithLeadingSlashInPattern() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate)
			.baseUrl("https://example.org")
			.stubs("classpath:/mappings/url-simple-path-pattern-with-leading-slash.json")
			.build();
		assertThat(this.restTemplate.getForObject("https://example.org/my/api", String.class))
			.isEqualTo("Hello Url Path Matcher");
		server.verify();
	...
	public void getWithUrlMatching() throws Exception {
		MockRestServiceServer server = WireMockRestServiceServer.with(this.restTemplate) //
			.baseUrl("https://example.org") //
			.stubs("classpath:/mappings/url-matches.json")
			.build();
