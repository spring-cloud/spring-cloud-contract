...
class Multipart extends DslProperty {
	...
	Multipart(Map<String, DslProperty> multipart) {
		super(
				extractValue(multipart, { DslProperty p -> p.clientValue }),
				extractValue(multipart, { DslProperty p -> p.serverValue }))
	}
	...
	Multipart(List<DslProperty> multipartAsList) {
		super(multipartAsList.collect { DslProperty p -> p.clientValue }, multipartAsList.
				collect { DslProperty p -> p.serverValue })
	}
