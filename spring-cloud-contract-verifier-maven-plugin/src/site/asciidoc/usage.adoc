...
== Converting Spring Cloud Contract DSL into WireMock stub mappings
   ...
   mvn org.springramework.cloud:spring-cloud-contract-verifier-maven-plugin:convert
...
Run stubs mappings from current directory:
    ...
    mvn org.springramework.cloud:spring-cloud-contract-verifier-maven-plugin:run
