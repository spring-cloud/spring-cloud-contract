...
----
// for Apache Camel
testCompile "org.springframework.cloud.contract:spring-cloud-verifier-camel:${verifierVersion}"
// for Spring Integration
testCompile "org.springframework.cloud.contract:spring-cloud-verifier-integration:${verifierVersion}"
// for Spring Cloud Stream
testCompile "org.springframework.cloud.contract:spring-cloud-verifier-stream:${verifierVersion}"
----
