...
TIP: You must understand the map notation in order to set up contracts. See the
...
Your CI might run something a command such as `./mvnw clean deploy`, which would publish both the
